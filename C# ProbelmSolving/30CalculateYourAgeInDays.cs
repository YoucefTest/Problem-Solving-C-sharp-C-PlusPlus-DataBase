...
class Program
{
    ...
    public static sDate ReadDateToday()
    {
        sDate Date;
    ...
    public static sDate AddOneDay1(sDate Date1)
    {
        int CurrentDays = GetHowManyDaysInMonth(Date1.Month, Date1.Year);

        if (Date1.Day == CurrentDays)
        {
            Date1.Day = 1;
